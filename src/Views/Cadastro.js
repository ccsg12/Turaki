...
export default (props) => {
  ...
  return (
    ...
    >
      ...
      <ImageBackground
        source={require("../../assets/images/Logos/LogoParteDireita1.png")}
        style={style.container}
      >
        <Text style={[Estilo.subtitulo, style.text]}>Junte-se a nós!</Text>
        <Text style={[Estilo.subtitulo2, { color: "#00BA40" }]}>
        ...
        <Text style={[Estilo.normal, { color: "#B53122" }]}>
          Temos diversas opções de cadastro
        </Text>
